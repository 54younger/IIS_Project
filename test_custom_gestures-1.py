...
NERVOUS_BEHAVIOR = {
    ...
    "frames": [
        ...
        # slow blink (use squint to simulate a slower blink without changing existing params)
        {
            "time": [0.65, 1.05],
            "persist": False,
            "params": {
...
CONFIDENT_BEHAVIOR = {
    ...
    "frames": [
        ...
        # BrowRaise during the smile (chosen at 0.6 to align with the smile window [0.3, 0.7])
        {
            "time": [0.6],
            "persist": False,
            "params": {
...
DEFENSIVE_BEHAVIOR = {
    ...
    "frames": [
        ...
        # gaze away (subtle eye-gaze shift to avoid direct stare)
        {
            "time": [0.55, 1.35],
            "persist": False,
            "params": {
...
NEUTRAL_BEHAVIOR = {
    ...
    "frames": [
        ...
        # Thoughtful (add mild brow-in + slight squint to convey thinking)
        {
            "time": [0.2, 0.7],
            "persist": False,
            "params": {
